...
CPP_FILES = main.cpp grilla.cpp celda.cpp defaultcelda.cpp celdaterrestre.cpp sismov.cpp personaje.cpp render_interfaz_mapa.cpp managerpersonaje.cpp menu.cpp juego.cpp cursor.cpp partida.cpp proc_input.cpp
